...
The Task Agent read and prioritize tasks from PostgreSQL MCP. It operates within the multi-agent briefing pipeline and never produces user-facing markdown directly.
